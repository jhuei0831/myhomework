...
@section('title', trans('action.upload.upload').trans('action.import.import'))
@section('content')
            ...
            <div class="card">
                <form action="{{ route('upload.import') }}" method="POST" enctype="multipart/form-data">
                    <div class="card-header text-white bg-info">
                        <h4><i class="fas fa-clipboard-list"></i> {{ trans('action.upload.upload').trans('action.import.import') }}</h4>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled">
                            <li>{{ App\Button::GoBack(route('upload.index')) }}</li>
                        </ul>
                        @csrf
