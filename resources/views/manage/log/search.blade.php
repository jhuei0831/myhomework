            ...
            <div class="card">
                ...
                <div class="card-body">
                	...
                	<ul class="list-inline">
						...
						<li class="list-inline-item">{{ App\Button::To(false,route('log.index'),trans('action.reset'),null,'btn-secondary','undo') }}</li>
					</ul>
					{{-- 篩選器設定 --}}
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group" >
                                    <input id="datepicker1" type="text" class="form-control" name="start" />
                                    <span class="input-group-addon">-</span>
                                    <input id="datepicker2" type="text" class="form-control" name="end" />
                                </div>
                            </div>
                        </div>
