    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                @if (Auth::check())
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('home') }}">{{ trans('homework.list') }}</a>
                    </li>
                @endif
            </ul>
            ...
            <ul class="navbar-nav ml-auto">
                @if (Auth::check() && Auth::user()->permission > 0)
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('manage') }}">{{ trans('action.backstage') }}</a>
                    </li>
                @endif
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item set_language" data-language="zh-TW">
                            中文
                        </a>
                        <a class="dropdown-item set_language" data-language="en">
                            English
                        </a>
                    </div>
                </li>
